...
>    - Bot name: Something friendly (e.g., "Ark Assistant")
>    - Bot username: Must end with "bot" (e.g., "ark_ai_bot")
...
```bash
npx tsx setup/index.ts --step register -- --jid "tg:<chat-id>" --name "<chat-name>" --folder "telegram_main" --trigger "@Ark" --channel telegram --no-trigger-required --is-main
```

For additional chats (trigger-only):

```bash
npx tsx setup/index.ts --step register -- --jid "tg:<chat-id>" --name "<chat-name>" --folder "telegram_<group-name>" --trigger "@Ark" --channel telegram
```
...
> - For non-main: `@Ark hello` or @mention the bot
>
