 ...
 * - REM Sleep: weekly on Sundays at 4:00 AM local time
 *
...
const REM_SLEEP_HOUR = 4; // 4 AM local time
...
export function startDreamingScheduler(): void {
  ...
  // REM sleep: Sundays at 4 AM
  scheduleRemSleep();

  logger.info('Dreaming scheduler started (light: 6h, deep: 3AM daily, REM: Sun 4AM)');
}
